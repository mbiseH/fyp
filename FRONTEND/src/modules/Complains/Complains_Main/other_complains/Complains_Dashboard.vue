          ...
          <v-flex xs12 sm6 md3 lg3>
            <v-hover v-slot="{ hover }" open-delay="200">
              <v-card
                ...
                link
                to="/more_about_status"
              >
                <v-card-title> Completed Complains</v-card-title>
                <v-card-text
                  ><span>
          ...
          <v-flex xs12 sm6 md3 lg3>
            <v-hover v-slot="{ hover }" open-delay="200">
              <v-card
                ...
                to="/more_about_status"
              >
                <v-card-title> Complains Delayed</v-card-title>
                <v-card-text
                  ><span>
          ...
          <v-flex xs12 sm6 md3 lg3>
            <v-hover v-slot="{ hover }" open-delay="200">
              <v-card
                ...
                to="/more_about_status"
              >
                <v-card-title>Complains on progress</v-card-title>
                <v-card-text
                  ><span>
          ...
          <v-flex xs12 sm6 md3 lg3>
            <v-hover v-slot="{ hover }" open-delay="200">
              <v-card
                ...
                to="/more_about_status"
              >
                <v-card-title>Complains on Hold</v-card-title>
                <v-card-text
                  ><span>
                    <center><v-chip color="#ffaa2c">12</v-chip></center></span
                  ></v-card-text
