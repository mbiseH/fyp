# Generated by Django 3.2.9 on 2022-05-02 13:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('appointment_type', models.CharField(choices=[('Indiv', 'Individual'), ('Grp', 'Group')], default='Indiv', max_length=10)),
                ('appointment_category', models.CharField(choices=[('Priv', 'Private'), ('Acad', 'Academic'), ('Other', 'Others')], default='Acad', max_length=10)),
